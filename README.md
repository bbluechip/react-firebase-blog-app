...
Project still on progress, I have some bugs...

## Used in this project

👉 React js, Create react app, react-router-dom, firebase, react-redux, redux-thunk, formik, yup, react-material-ui, useSelector, useEffect, useState, toastify, firebase-database, firebase-auth etc.
